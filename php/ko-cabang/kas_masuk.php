...
<h4 class="page-header">.:: Kas Operasional Cabang - Kas Masuk ::.</h4>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">.:: Data Kas Masuk Cabang Baru ::.</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <select id="vjenis_biaya" class="form-control">
                    ...
                    <option value="5">Realisasi</option>                   
                  </select>   
                </div>
...
<div class="modal fade" id="update_kas_pusat_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">.:: Data Kas Masuk Cabang Update ::.</h4>
            </div>
            <div class="modal-body">
