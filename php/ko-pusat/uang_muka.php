...
<h4 class="page-header">.:: Kas Operasional Pusat - Uang Muka ::.</h4>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">.:: Uang Muka Pusat Baru ::.</h4>
            </div>
...
<div class="modal fade" id="update_kas_pusat_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">.:: Uang Muka Pusat Update ::.</h4>
            </div>
            <div class="modal-body">
        ...
        <input type="hidden" id="vbagian-update" value="PUSAT">
...
<div class="modal fade" id="realisasi_kas_pusat_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">.:: Realisasi Uang Muka Pusat ::.</h4>
            </div>
            <div class="modal-body">
        ...
        <input type="hidden" id="vbagian-realisasi" value="PUSAT">
