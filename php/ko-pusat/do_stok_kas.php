...
<h4 class="page-header">.:: Kas Operasional Pusat - Stok KAS Harian ::.</h4>
 <div class="messageError"></div>
 <div class="messageInfo"></div>
 <input type="hidden" id="vid_saldo_kas">
  <div class="row"> 
...
<div class="row">
    ...
    <div class="form-group">
      <!--Stok Kas Operasional Pusat <?php echo $today; ?> -->
      ...
      <div class="input-group">
      <span class="input-group-addon">Rp</span>        
        <input type="text" value="0" id="v_total_kas" class="form-control" placeholder="Stok Kas Operasional Pusat" /> 
      </div>     
      </div>
    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Stok Kas Harian Operasional PUSAT</h4>
                    </div>
