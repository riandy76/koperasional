...
var $aligns;
    ...
    {
        global $judul, $bulan;
        /**Cek apakah halaman 1, jika iya, maka header hanya berada di halaman 1**/
         if ($this->page == 1)
        {
    
    // Logo
        $this->Image('../../assets/images/logo.jpg',10,6,30);
    // Arial bold 15
    ...
    //nomor kas
        ...
        $this->Cell(20,6,'BULAN : ', 1);
        $this->Cell(40, 6, strtoupper($bulan), 1, 1, 'C');
        // $this->SetX(235);
